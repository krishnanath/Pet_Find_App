...
// // Insert Alert
// container.innerBefore(div, form);
...
function fetchAnimals(e) {
  ...
  if (!(0, _validate.isValidZip)(zip)) {
    (0, _validate.showAlert)('Please enter Valid Zipcode', 'danger');
    return;
  }

  // Fetch Pets
  (0, _fetchJsonp2.default)('http://api.petfinder.com/pet.find?format=json&key=b28b2ca49a04cfa306858ad3feb4d1d6&animal=' + animal + '&location=' + zip + '&callback=callback', {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '61088' + '/');
...
//# sourceMappingURL=/main.9dc29b58.map