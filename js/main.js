...
function fetchAnimals(e) {
    ...
    //Validate Zip
    if(!isValidZip(zip)){
        showAlert('Please enter Valid Zipcode', 'danger');
        return;
    }

    // Fetch Pets
    fetchJsonp(`http://api.petfinder.com/pet.find?format=json&key=b28b2ca49a04cfa306858ad3feb4d1d6&animal=${animal}&location=${zip}&callback=callback`, {
